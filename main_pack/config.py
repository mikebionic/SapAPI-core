...
class Config:
	...
	HALKBANK_PAYMENT_SERVICE_URL = environ.get('HALKBANK_PAYMENT_SERVICE_URL')
	HALKBANK_PAYMENT_REGISTER_URL = environ.get('HALKBANK_PAYMENT_REGISTER_URL')
	HALKBANK_PAYMENT_SERVICE_USERNAME = environ.get('HALKBANK_PAYMENT_SERVICE_USERNAME')
	HALKBANK_PAYMENT_SERVICE_PASSWORD = environ.get('HALKBANK_PAYMENT_SERVICE_PASSWORD')
	HALKBANK_PAYMENT_VALIDATION_KEY = environ.get('HALKBANK_PAYMENT_VALIDATION_KEY')
	HALKBANK_PAYMENT_VALIDATION_VALUE = environ.get('HALKBANK_PAYMENT_VALIDATION_VALUE')
