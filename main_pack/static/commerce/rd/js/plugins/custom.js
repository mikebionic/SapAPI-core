...
(function(jQuery) {
    ...
    $('.cd-add-to-cart').on('click', function(e){
      ...
      if($(this).hasClass('added')){
          $(this).removeClass('added').find('i').removeClass('ri-check-line').addClass('ri-shopping-cart-line'); 
      } else{
          $(this).addClass('added').find('i').addClass('ri-check-line').removeClass('ri-shopping-cart-line'); 
      }
  });
})(jQuery);