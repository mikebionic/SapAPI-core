...
from main_pack.models_test.commerce.models import Work_period
from main_pack.api_test.commerce.utils import addWorkPeriodDict
			...
			for work_period in req:
				...
				try:
					if not 'WpId' in work_period:
						...
						db_test.session.add(newWorkPeriod)
