# from main_pack.models import (Contact)
...
# used foreign keys
from main_pack.models import Unit,Brand,Usage_status
from main_pack.models import Company,Division,Res_category,Resource_type,Resource_maker
